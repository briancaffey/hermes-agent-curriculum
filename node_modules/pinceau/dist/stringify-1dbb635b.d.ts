import { T as TokensFunctionOptions, E as TokensFunction, o as PinceauContext, l as PinceauMediaQueries, C as ColorSchemeModes } from './index-82919e08.js';
...
declare function getResolvedSelectors(parentSelectors: any, 
/** @type {string[]} Nested selectors (e.g. `["&:hover", "&:focus"]`). */
nestedSelectors: any): any;
/** Returns a string of CSS from an object of CSS. */
declare function stringify(value: any, 
/** Replacer function. */
replacer?: any): string;
