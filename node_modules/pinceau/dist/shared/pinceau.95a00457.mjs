import { l as expressionToAst, q as astTypes, o as printAst, j as parseAst, v as visitAst, k as parseVueComponent, t as transformCssFunction, i as transformVariants, b as message, n as defaultExport, m as merger, u as useDebugPerformance } from './pinceau.ff79c5c3.mjs';
import 'ohash';
import 'scule';
import process from 'node:process';
import { u as dtRegex, j as mqCssRegex, q as lightRegex, l as darkRegex, v as variantsRegex, w as walkTokens, n as normalizeConfig, o as outputFileNames, g as resolveThemeRule, c as createTokensHelper } from './pinceau.bac397e4.mjs';
...
function transformDtHelper(code, ctx, wrapper = void 0) {
...
function flattenTokens(data, toValue = false, raw = true) {
...
function loadVueStyle(query, ctx) {
...
async function importConfigFile({ path, ext }) {
  ...
  console.log({
    path,
    imported: await jiti.import(path, { default: true })
  });
  return {
    path,
    content,
...
function stringifyUtils(value, definitions) {
...
function cssFull(dictionary, options, responsiveTokens, colorSchemeMode) {
...
function definitionsFull(definitions) {
...
function utilsFull(utils = {}, utilsImports = [], definitions = {}) {
