...
const unplugin = require('./shared/pinceau.81a0dd7d.cjs');
const context = require('./shared/pinceau.6f7ae971.cjs');
const query = require('./shared/pinceau.5a583837.cjs');
require('defu');
require('acorn');
        ...
        transformers.push(
          (component, code) => {
            ...
            if (!cachedTokens && fs.existsSync(path.join(options.outputDir, "index.ts"))) {
              const _tokens = createJITI(options.outputDir)(path.join(options.outputDir, "index.ts")).default;
