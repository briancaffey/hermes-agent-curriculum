...
type PinceauMediaQueries = 'dark' | 'light' | 'initial' | keyof PinceauTheme['media'];
...
type CSSProperties<ComponentProps = {}, MediaQueries extends string = WrapUnion<PinceauMediaQueries, '@', ''>, UtilsProperties = PinceauUtils> = {
