import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, computed, onServerPrefetch, watch, unref, defineAsyncComponent, toRef, defineComponent, shallowRef, h, resolveComponent, shallowReactive, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, toDisplayString, renderSlot, readonly, nextTick, onMounted, getCurrentScope, onScopeDispose, createElementBlock, provide, cloneVNode, useSSRContext, Suspense, Fragment, createApp, reactive, createTextVNode, renderList, onErrorCaptured, effectScope, createSlots, isReadonly, isShallow, isReactive, toRaw } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/ofetch/dist/node.mjs';
import { j as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, getRequestHeader, sanitizeStatusCode, setCookie, getCookie, deleteCookie, appendHeader } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue-router/vue-router.node.mjs';
import { defu, defuFn } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/defu/dist/defu.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase, parseQuery, withTrailingSlash, hasProtocol, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/ufo/dist/index.mjs';
...
import { parse } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { nanoid } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/nanoid/index.js';
import { kebabCase } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/scule/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrRenderTeleport, ssrRenderAttr, ssrRenderSuspense, ssrRenderStyle } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue/server-renderer/index.mjs';
import { Icon as Icon$1 } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/@iconify/vue/dist/offline.mjs';
import { loadIcon } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/@iconify/vue/dist/iconify.mjs';
import { useFuse } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/@vueuse/integrations/useFuse.mjs';
import { useFocusTrap } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/@vueuse/integrations/useFocusTrap.mjs';
import { debounce } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/perfect-debounce/dist/index.mjs';
import { walkResolver } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { prerender: true, payload: true };
  return (m, p) => {
    let r = [];
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-DKhUzdkh.mjs')
  }
];
...
const plugin$1 = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const history2 = routerOptions.history?.(routerBase) ?? createMemoryHistory(routerBase);
...
const LazyAppDocSearch = defineAsyncComponent(() => Promise.resolve().then(() => AppDocSearch).then((r) => r["default"] || r.default || r));
const LazyAppFooter = defineAsyncComponent(() => Promise.resolve().then(() => AppFooter).then((r) => r["default"] || r.default || r));
const LazyAppHeader = defineAsyncComponent(() => Promise.resolve().then(() => AppHeader).then((r) => r["default"] || r.default || r));
const LazyAppHeaderDialog = defineAsyncComponent(() => Promise.resolve().then(() => AppHeaderDialog).then((r) => r["default"] || r.default || r));
const LazyAppHeaderLogo = defineAsyncComponent(() => Promise.resolve().then(() => AppHeaderLogo).then((r) => r["default"] || r.default || r));
const LazyAppHeaderNavigation = defineAsyncComponent(() => Promise.resolve().then(() => AppHeaderNavigation).then((r) => r["default"] || r.default || r));
const LazyAppLayout = defineAsyncComponent(() => Promise.resolve().then(() => AppLayout).then((r) => r["default"] || r.default || r));
const LazyAppLoadingBar = defineAsyncComponent(() => Promise.resolve().then(() => AppLoadingBar).then((r) => r["default"] || r.default || r));
const LazyAppSearch = defineAsyncComponent(() => Promise.resolve().then(() => AppSearch).then((r) => r["default"] || r.default || r));
const LazyAppSocialIcons = defineAsyncComponent(() => Promise.resolve().then(() => AppSocialIcons).then((r) => r["default"] || r.default || r));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound--BNel4AZ.mjs').then((r) => r["default"] || r.default || r));
const LazyEllipsis = defineAsyncComponent(() => import('./Ellipsis-CacO-JLq.mjs').then((r) => r["default"] || r.default || r));
const LazyLogo = defineAsyncComponent(() => Promise.resolve().then(() => Logo).then((r) => r["default"] || r.default || r));
const LazyThemeSelect = defineAsyncComponent(() => Promise.resolve().then(() => ThemeSelect).then((r) => r["default"] || r.default || r));
const LazyDocsAside = defineAsyncComponent(() => import('./DocsAside-BpZzOm_L.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(() => DocsAsideTree).then((r) => r["default"] || r.default || r));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./DocsPageBottom-CbAS-otL.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./DocsPageLayout--KFc6nzY.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./DocsPrevNext-HMaT3V42.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsToc = defineAsyncComponent(() => import('./DocsToc-Bm0xHI7s.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./DocsTocLinks-B6GtNhDV.mjs').then((r) => r["default"] || r.default || r));
const LazyEditOnLink = defineAsyncComponent(() => import('./EditOnLink-CIxzRy8l.mjs').then((r) => r["default"] || r.default || r));
const LazySourceLink = defineAsyncComponent(() => import('./SourceLink-CkG4bd5j.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CYmLzAK1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-BlG8dtbM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-D6EOAJ5o.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-DsV1x5Na.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-Cpf0eT0N.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BT52juR0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-C5feXhCx.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BEJemKd3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-fB1WWSlH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-unuRVFaG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-CUig7LCH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-BIhJM_YW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-D08xZNSy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-Bi61jGJ8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BwhW1xBP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-39WAG-op.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-DsoE-7t9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-U6qqY0FT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DXSrpq4B.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-DsR_y1u_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DKGzQ4n2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-DuDL9xxW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-B8XmnA7u.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-bTvDDXmY.mjs').then((r) => r["default"] || r.default || r));
const LazyAlert = defineAsyncComponent(() => import('./Alert-aNo17HoM.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./Badge-BVfkpPQH.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonLink = defineAsyncComponent(() => import('./ButtonLink-Bepbxwxt.mjs').then((r) => r["default"] || r.default || r));
const LazyCallout = defineAsyncComponent(() => import('./Callout-8SB1di3Q.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-CW8sVuKN.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-DgMnJmrS.mjs').then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(() => Container).then((r) => r["default"] || r.default || r));
const LazyCopyButton = defineAsyncComponent(() => import('./CopyButton-Mdtdvrxx.mjs').then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import('./List-DBlEqPRK.mjs').then((r) => r["default"] || r.default || r));
const LazyNuxtImg = defineAsyncComponent(() => import('./NuxtImg-JZXUMDOC.mjs').then((r) => r["default"] || r.default || r));
const LazyProps = defineAsyncComponent(() => import('./Props-CXKsJJ-f.mjs').then((r) => r["default"] || r.default || r));
const LazySandbox = defineAsyncComponent(() => import('./Sandbox-tL-bR0Js.mjs').then((r) => r["default"] || r.default || r));
const LazyTabsHeader = defineAsyncComponent(() => import('./TabsHeader-CDSH2avX.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./Terminal-DR_D2lqB.mjs').then((r) => r["default"] || r.default || r));
const LazyVideoPlayer = defineAsyncComponent(() => import('./VideoPlayer-BXBSPtLB.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./IconCodeSandBox-Cn044pgx.mjs').then((r) => r["default"] || r.default || r));
const LazyIconDocus = defineAsyncComponent(() => import('./IconDocus-Dj-Q4KJQ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxt = defineAsyncComponent(() => import('./IconNuxt-CYKVc3wo.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./IconNuxtContent-CiAHu_DU.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./IconNuxtLabs-Cat9MUAQ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./IconNuxtStudio-V2wMvwD2.mjs').then((r) => r["default"] || r.default || r));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./IconStackBlitz-D1rPSlwr.mjs').then((r) => r["default"] || r.default || r));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./IconVueTelescope-BB00xEWq.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockHero = defineAsyncComponent(() => import('./BlockHero-B5YnGOiB.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./Card-olJJjmOQ.mjs').then((r) => r["default"] || r.default || r));
const LazyCardGrid = defineAsyncComponent(() => import('./CardGrid-OPLl_3o6.mjs').then((r) => r["default"] || r.default || r));
const LazyVoltaBoard = defineAsyncComponent(() => import('./VoltaBoard-s0nZruOv.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlayground = defineAsyncComponent(() => import('./ComponentPlayground-BzWvX57h.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./ComponentPlaygroundData-CUNXH8jI.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./ComponentPlaygroundProps-CfeWuDJi.mjs').then((r) => r["default"] || r.default || r));
...
const LazyPreviewLayout = defineAsyncComponent(() => import('./PreviewLayout-D32GpiXN.mjs').then((r) => r["default"] || r.default || r));
const LazyTokensPlayground = defineAsyncComponent(() => import('./TokensPlayground-BdpulfBp.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CjvbTeqX.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DO3uD5Ee.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-Bo27uQNr.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-BabxK73r.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-a4lwZxUE.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-CLbZBXp8.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-DfGDdgph.mjs').then((r) => r["default"] || r.default || r));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-CVfz7tly.mjs').then((r) => r["default"] || r.default || r));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-DxHUPX7s.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-DNLg-Rt5.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BvjIJ1CR.mjs').then((r) => r["default"] || r.default || r));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CdDw_hOA.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CdDw_hOA.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BHxIT3jm.mjs').then((m) => m.default || m)),
  page: defineAsyncComponent(() => import('./page-D-lgp9IG.mjs').then((m) => m.default || m))
};
const documentDriven_Se9_0YMz63eCuzcUaHfrIo_lx_X3kblGNHNEDoOgf7o = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
...
function resolveThemeRule(mq, content, theme2, colorSchemeMode) {
  ...
  if (mq === "dark" || mq === "light") {
    ...
    const queryToken = theme2?.media?.[mq];
    if (queryToken) {
...
function usePinceauThemeSheet(initialTheme, tokensHelperConfig = {}, colorSchemeMode) {
  ...
  function updateTheme(value) {
    const mqKeys = Array.from(/* @__PURE__ */ new Set(["dark", "light", ...Object.keys(value?.media || {}), ...Object.keys(theme2.value?.media || {})]));
...
const plugin = {
  install(app, options) {
    ...
    if (dev && true) {
      import('./debug-CIpES0ca.mjs').then(({ usePinceauRuntimeDebug }) => usePinceauRuntimeDebug(tokensHelperConfig));
    }
...
const pinceau_nuxt_plugin_server_CyjS0HBES1HTMn_vRhVZmEEVIcFEutqj6drKWA5na5Y = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  nuxtApp.vueApp.use(plugin, { colorSchemeMode: "class", theme, utils });
  const { pinceau: runtimeConfig } = /* @__PURE__ */ useRuntimeConfig();
...
const schema_server_p4CQLCQWMAVH4pkrq8mfODO1xMPLbfAygWwynjfn3o0 = /* @__PURE__ */ defineNuxtPlugin(() => {
  const event = useRequestEvent();
...
const menu_WRqeFGs0M_7XAwkTs1kuv99nOowtU8pC5RIA4xN8IUY = /* @__PURE__ */ defineNuxtPlugin((ctx) => {
...
const plugins = [
  ...
  documentDriven_Se9_0YMz63eCuzcUaHfrIo_lx_X3kblGNHNEDoOgf7o,
  pinceau_nuxt_plugin_server_CyjS0HBES1HTMn_vRhVZmEEVIcFEutqj6drKWA5na5Y,
  schema_server_p4CQLCQWMAVH4pkrq8mfODO1xMPLbfAygWwynjfn3o0,
  plugin_server_9Ca9_HhnjAGwBWpwAydRauMHxWoxTDY60BrArRnXN_A,
  menu_WRqeFGs0M_7XAwkTs1kuv99nOowtU8pC5RIA4xN8IUY,
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-a8d7e2a7"]]);
...
const useDocus = () => {
  ...
  const config = computed(
    () => {
      const titleTemplate = docus?.value?.titleTemplate || navKeyFromPath2(page?.value?._path, "titleTemplate", navigation.value || []) || `%s · ${docus?.value?.title || "Docus"}`;
  ...
  const tree = computed(() => {
    ...
    if (nav.length === 0) {
      nav = navPageFromPath2(page.value?._path || "/", navigation.value || []);
      if (!nav) {
        return [];
      }
      if (!Array.isArray(nav)) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.links, (link) => {
        _push(`<li class="${ssrRenderClass({
          "has-parent-icon": __props.parent?.icon,
        ...
        if (link.children) {
          ...
          if (link?.navigation?.icon || link.icon) {
          ...
          _push(`<span data-v-d42239fd>${ssrInterpolate(link?.navigation?.title || link.title || link._path)}</span></span><span data-v-d42239fd>`);
          _push(ssrRenderComponent(_component_Icon, {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-d42239fd${_scopeId}>${ssrInterpolate(link?.navigation?.title || link.title || link._path)}</span></span>`);
              } else {
                return [
                  createVNode("span", { class: "content" }, [
                    link?.navigation?.icon || link.icon ? (openBlock(), createBlock(_component_Icon, {
                      key: 0,
                      name: link?.navigation?.icon || link.icon,
                      class: "icon"
                    }, null, 8, ["name"])) : createCommentVNode("", true),
                    createVNode("span", null, toDisplayString(link?.navigation?.title || link.title || link._path), 1)
                  ])
                ];
              }
            }),
        ...
        if (link.children?.length && (__props.max === null || __props.level + 1 < __props.max)) {
      ...
      if (unref(hasNavigation)) {
        ...
        ssrRenderList(unref(tree), (link) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (link.icon && unref(config)?.header?.showLinkIcon) {
                  _push2(ssrRenderComponent(_component_Icon, {
                    name: link.icon
                  }, null, _parent2, _scopeId));
                } else {
                ...
                return [
                  link.icon && unref(config)?.header?.showLinkIcon ? (openBlock(), createBlock(_component_Icon, {
                    key: 0,
                    name: link.icon
                  }, null, 8, ["name"])) : createCommentVNode("", true),
...
const AppDocSearch = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    watch(selected, (value) => {
      ...
      if (nextId) (void 0).querySelector(`[id="${nextId}"]`)?.scrollIntoView({ block: "nearest" });
    });
    watch(
      q,
      (_) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$3;
      _push(`<!--[--><button type="button" aria-label="Search" data-v-d9f83610><span class="content" data-v-d9f83610>`);
      _push(ssrRenderComponent(_component_Icon, { name: "heroicons-outline:search" }, null, _parent));
      _push(`<span data-v-d9f83610>Search</span><span data-v-d9f83610><kbd data-v-d9f83610>⌘</kbd><kbd data-v-d9f83610>K</kbd></span></span></button>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(show)) {
          _push2(`<div class="search-content" data-v-d9f83610><div class="search-window" data-v-d9f83610><div class="search-input" data-v-d9f83610>`);
          _push2(ssrRenderComponent(_component_Icon, {
            name: "heroicons-outline:search",
            class: "search-icon"
          }, null, _parent));
          _push2(`<input${ssrRenderAttr("value", unref(q))} type="text" placeholder="Search documentation" data-v-d9f83610><button class="close-button" data-v-d9f83610>`);
          _push2(ssrRenderComponent(_component_Icon, {
          ...
          if (unref(results).length > 0) {
            _push2(`<div class="search-results" data-v-d9f83610><!--[-->`);
            ssrRenderList(unref(results), (result, i) => {
              _push2(`<div${ssrRenderAttr("id", result.item.id)} class="${ssrRenderClass([{ selected: unref(selected) === i }, "search-result"])}" data-v-d9f83610><div class="search-result-content-wrapper" data-v-d9f83610><div class="search-result-content-head" data-v-d9f83610>`);
              if (getNavItemMeta(result?.item?.path)?.directoryIcon) {
                _push2(ssrRenderComponent(_component_Icon, {
              ...
              if (getNavItemMeta(result?.item?.path)?.directoryTitle) {
                _push2(`<span data-v-d9f83610>${ssrInterpolate(getNavItemMeta(result?.item?.path)?.directoryTitle)} <span class="arrow" data-v-d9f83610>${`→`}</span></span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span data-v-d9f83610>${ssrInterpolate(result.item.title)}</span></div>`);
              if (result?.matches?.[0]) {
                _push2(`<p class="search-result-content-preview" data-v-d9f83610><span data-v-d9f83610>“</span><span data-v-d9f83610>${`${highlight(unref(q), result?.matches?.[0])}` ?? ""}</span><span data-v-d9f83610>“</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            _push2(`<div class="search-results empty" data-v-d9f83610> Type your query to search docs </div>`);
          } else {
            _push2(`<div class="search-results empty" data-v-d9f83610> No results found. Try another query </div>`);
          }
          _push2(`</div></div>`);
        } else {
          _push2(`<!---->`);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-d9f83610"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Container, {
        fluid: unref(config)?.header?.fluid
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Container, {
        fluid: unref(config)?.footer?.fluid,
        padded: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(config)?.footer?.credits) {
              _push2(`<a${ssrRenderAttr("href", unref(config)?.footer?.credits?.href || "#")} rel="noopener" target="_blank" data-v-39bdaab3${_scopeId}>`);
              if (unref(config)?.footer?.credits?.icon) {
                _push2(ssrRenderComponent(_component_Icon, {
                  name: unref(config)?.footer?.credits?.icon,
                  class: "left-icon"
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              if (unref(config)?.footer?.credits?.text) {
            ...
            ssrRenderList(unref(icons).slice(0, 6 - unref(nbSocialIcons)), (icon) => {
              _push2(`<a class="icon-link"${ssrRenderAttr("aria-label", icon.label)}${ssrRenderAttr("href", icon.href)} target="_blank"${ssrRenderAttr("rel", icon?.rel || "noopener noreferrer")} data-v-39bdaab3${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: icon.icon
              }, null, _parent2, _scopeId));
              _push2(`</a>`);
            ...
            return [
              createVNode("div", { class: "left" }, [
                unref(config)?.footer?.credits ? (openBlock(), createBlock("a", {
                  key: 0,
                  href: unref(config)?.footer?.credits?.href || "#",
                  rel: "noopener",
                  target: "_blank"
                }, [
                  unref(config)?.footer?.credits?.icon ? (openBlock(), createBlock(_component_Icon, {
                    key: 0,
                    name: unref(config)?.footer?.credits?.icon,
                    class: "left-icon"
                  }, null, 8, ["name"])) : createCommentVNode("", true),
                  unref(config)?.footer?.credits?.text ? (openBlock(), createBlock("p", { key: 1 }, toDisplayString(unref(config).footer.credits.text), 1)) : createCommentVNode("", true)
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cl-v9_9g.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DkdSQIx2.mjs'));
...
export { useAsyncData as A, useColorMode as B, useVModel as C, usePinceauTheme as D, queryContent as E, fetchContentNavigation as F, get$1 as G, assertArray as H, ensureArray as I, omit as J, sortList as K, LayoutMetaSymbol as L, apply as M, withoutKeys as N, withKeys as O, PageRouteSymbol as P, createQuery as Q, _export_sfc as _, __nuxt_component_0$5 as a, useNuxtApp as b, useRoute as c, appLayoutTransition as d, entry_default as default, _mergeTransitionProps as e, _wrapInTransition as f, _routeRulesMatcher as g, useRuntimeConfig as h, useContent as i, useRequestEvent as j, useContentHead as k, layouts as l, useContentPreview as m, usePinceauRuntime as n, __nuxt_component_0$3 as o, computedStyle as p, useDocus as q, __nuxt_component_0$2 as r, useAppConfig as s, useState as t, useHead as u, __nuxt_component_0$4 as v, useContentHelpers as w, useRouter as x, useClipboard as y, onClickOutside as z };
