import { _ as _export_sfc, s as useAppConfig, a as __nuxt_component_0$5, o as __nuxt_component_0$3 } from './server.mjs';
import { defineComponent, computed, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h4${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-57e8d291>`);
...
//# sourceMappingURL=ProseH4-fB1WWSlH.mjs.map
