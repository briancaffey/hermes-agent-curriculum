import { prefixStorage } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/unstorage/dist/index.mjs';
import { isRelative, joinURL, withLeadingSlash, withoutTrailingSlash } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/ohash/dist/index.mjs';
import defu from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/defu/dist/defu.mjs';
import { extname } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/pathe/dist/index.mjs';
import { camelCase } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/scule/dist/index.mjs';
...
import { toString } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/micromark/index.js';
import { stringifyPosition } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/micromark-util-character/index.js';
import { push, splice } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/micromark-util-chunked/index.js';
import { resolveAll } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/micromark-util-sanitize-uri/index.js';
import { f as parseMarkdown, a as useRuntimeConfig, i as isPreview, c as useStorage, h as getPreview, e as useNitroApp } from '../nitro/nitro.mjs';
import { parseFrontMatter } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/remark-mdc/dist/index.mjs';
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/brian/git/hermes-agent-curriculum/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
export { storage as a, contentIndex as c, serverQueryContent as s };
