import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/h3/dist/index.mjs';
import { joinURL } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue/server-renderer/index.mjs';
import { b as buildAssetsURL, a as useRuntimeConfig, c as useStorage, d as defineRenderHandler, p as publicAssetsURL, g as getRouteRules, e as useNitroApp } from '../nitro/nitro.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/devalue/index.js';
import { isRef, toValue } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A comprehensive, step-by-step curriculum to understand the Hermes Agent codebase from NousResearch."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"Hermes Agent Architecture Course"};
