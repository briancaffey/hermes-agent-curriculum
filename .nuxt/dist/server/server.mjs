import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, ref, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, nextTick, unref, resolveComponent, watch, onScopeDispose, mergeProps, useSSRContext, createVNode, resolveDynamicComponent, withCtx, renderSlot, withAsyncContext, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, createTextVNode, readonly, onMounted, createSlots, renderList, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/brian/git/hermes-agent-curriculum/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/brian/git/hermes-agent-curriculum/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/brian/git/hermes-agent-curriculum/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from "/home/brian/git/hermes-agent-curriculum/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu, defuFn } from "/home/brian/git/hermes-agent-curriculum/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, withoutTrailingSlash, withBase, withLeadingSlash, parseQuery, withTrailingSlash } from "/home/brian/git/hermes-agent-curriculum/node_modules/ufo/dist/index.mjs";
import { hash } from "/home/brian/git/hermes-agent-curriculum/node_modules/ohash/dist/index.mjs";
import { klona } from "/home/brian/git/hermes-agent-curriculum/node_modules/klona/dist/index.mjs";
import { parse } from "/home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/home/brian/git/hermes-agent-curriculum/node_modules/destr/dist/index.mjs";
import { isEqual } from "/home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/ohash/dist/index.mjs";
import { nanoid } from "nanoid";
import { kebabCase } from "/home/brian/git/hermes-agent-curriculum/node_modules/scule/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/brian/git/hermes-agent-curriculum/node_modules/nuxt/node_modules/@unhead/vue/dist/index.mjs";
...
import { debounce } from "/home/brian/git/hermes-agent-curriculum/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/document-driven-DKhUzdkh.js")
  }
];
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenNotFound--BNel4AZ.js").then((r) => r["default"] || r.default || r));
const LazyEllipsis = defineAsyncComponent(() => import("./_nuxt/Ellipsis-CacO-JLq.js").then((r) => r["default"] || r.default || r));
...
const LazyDocsAside = defineAsyncComponent(() => import("./_nuxt/DocsAside-BpZzOm_L.js").then((r) => r["default"] || r.default || r));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(() => DocsAsideTree).then((r) => r["default"] || r.default || r));
const LazyDocsPageBottom = defineAsyncComponent(() => import("./_nuxt/DocsPageBottom-CbAS-otL.js").then((r) => r["default"] || r.default || r));
const LazyDocsPageLayout = defineAsyncComponent(() => import("./_nuxt/DocsPageLayout--KFc6nzY.js").then((r) => r["default"] || r.default || r));
const LazyDocsPrevNext = defineAsyncComponent(() => import("./_nuxt/DocsPrevNext-HMaT3V42.js").then((r) => r["default"] || r.default || r));
const LazyDocsToc = defineAsyncComponent(() => import("./_nuxt/DocsToc-Bm0xHI7s.js").then((r) => r["default"] || r.default || r));
const LazyDocsTocLinks = defineAsyncComponent(() => import("./_nuxt/DocsTocLinks-B6GtNhDV.js").then((r) => r["default"] || r.default || r));
const LazyEditOnLink = defineAsyncComponent(() => import("./_nuxt/EditOnLink-CIxzRy8l.js").then((r) => r["default"] || r.default || r));
const LazySourceLink = defineAsyncComponent(() => import("./_nuxt/SourceLink-CkG4bd5j.js").then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-CYmLzAK1.js").then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-BlG8dtbM.js").then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-D6EOAJ5o.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-DsV1x5Na.js").then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-Cpf0eT0N.js").then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-BT52juR0.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-C5feXhCx.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-BEJemKd3.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-fB1WWSlH.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-unuRVFaG.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-CUig7LCH.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-BIhJM_YW.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-D08xZNSy.js").then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-Bi61jGJ8.js").then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-BwhW1xBP.js").then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-39WAG-op.js").then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-DsoE-7t9.js").then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-U6qqY0FT.js").then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-DXSrpq4B.js").then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-DsR_y1u_.js").then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-DKGzQ4n2.js").then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-DuDL9xxW.js").then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-B8XmnA7u.js").then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-bTvDDXmY.js").then((r) => r["default"] || r.default || r));
const LazyAlert = defineAsyncComponent(() => import("./_nuxt/Alert-aNo17HoM.js").then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import("./_nuxt/Badge-BVfkpPQH.js").then((r) => r["default"] || r.default || r));
const LazyButtonLink = defineAsyncComponent(() => import("./_nuxt/ButtonLink-Bepbxwxt.js").then((r) => r["default"] || r.default || r));
const LazyCallout = defineAsyncComponent(() => import("./_nuxt/Callout-8SB1di3Q.js").then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import("./_nuxt/CodeBlock-CW8sVuKN.js").then((r) => r["default"] || r.default || r));
const LazyCodeGroup = defineAsyncComponent(() => import("./_nuxt/CodeGroup-DgMnJmrS.js").then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(() => Container).then((r) => r["default"] || r.default || r));
const LazyCopyButton = defineAsyncComponent(() => import("./_nuxt/CopyButton-Mdtdvrxx.js").then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import("./_nuxt/List-DBlEqPRK.js").then((r) => r["default"] || r.default || r));
const LazyNuxtImg = defineAsyncComponent(() => import("./_nuxt/NuxtImg-JZXUMDOC.js").then((r) => r["default"] || r.default || r));
const LazyProps = defineAsyncComponent(() => import("./_nuxt/Props-CXKsJJ-f.js").then((r) => r["default"] || r.default || r));
const LazySandbox = defineAsyncComponent(() => import("./_nuxt/Sandbox-tL-bR0Js.js").then((r) => r["default"] || r.default || r));
const LazyTabsHeader = defineAsyncComponent(() => import("./_nuxt/TabsHeader-CDSH2avX.js").then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import("./_nuxt/Terminal-DR_D2lqB.js").then((r) => r["default"] || r.default || r));
const LazyVideoPlayer = defineAsyncComponent(() => import("./_nuxt/VideoPlayer-BXBSPtLB.js").then((r) => r["default"] || r.default || r));
const LazyIconCodeSandBox = defineAsyncComponent(() => import("./_nuxt/IconCodeSandBox-Cn044pgx.js").then((r) => r["default"] || r.default || r));
const LazyIconDocus = defineAsyncComponent(() => import("./_nuxt/IconDocus-Dj-Q4KJQ.js").then((r) => r["default"] || r.default || r));
const LazyIconNuxt = defineAsyncComponent(() => import("./_nuxt/IconNuxt-CYKVc3wo.js").then((r) => r["default"] || r.default || r));
const LazyIconNuxtContent = defineAsyncComponent(() => import("./_nuxt/IconNuxtContent-CiAHu_DU.js").then((r) => r["default"] || r.default || r));
const LazyIconNuxtLabs = defineAsyncComponent(() => import("./_nuxt/IconNuxtLabs-Cat9MUAQ.js").then((r) => r["default"] || r.default || r));
const LazyIconNuxtStudio = defineAsyncComponent(() => import("./_nuxt/IconNuxtStudio-V2wMvwD2.js").then((r) => r["default"] || r.default || r));
const LazyIconStackBlitz = defineAsyncComponent(() => import("./_nuxt/IconStackBlitz-D1rPSlwr.js").then((r) => r["default"] || r.default || r));
const LazyIconVueTelescope = defineAsyncComponent(() => import("./_nuxt/IconVueTelescope-BB00xEWq.js").then((r) => r["default"] || r.default || r));
const LazyBlockHero = defineAsyncComponent(() => import("./_nuxt/BlockHero-B5YnGOiB.js").then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import("./_nuxt/Card-olJJjmOQ.js").then((r) => r["default"] || r.default || r));
const LazyCardGrid = defineAsyncComponent(() => import("./_nuxt/CardGrid-OPLl_3o6.js").then((r) => r["default"] || r.default || r));
const LazyVoltaBoard = defineAsyncComponent(() => import("./_nuxt/VoltaBoard-s0nZruOv.js").then((r) => r["default"] || r.default || r));
const LazyComponentPlayground = defineAsyncComponent(() => import("./_nuxt/ComponentPlayground-BzWvX57h.js").then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundData-CUNXH8jI.js").then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundProps-CfeWuDJi.js").then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundSlots = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundSlots-LQAtWwPl.js").then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundTokens = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundTokens-Dpp38m-H.js").then((r) => r["default"] || r.default || r));
const LazyPreviewLayout = defineAsyncComponent(() => import("./_nuxt/PreviewLayout-D32GpiXN.js").then((r) => r["default"] || r.default || r));
const LazyTokensPlayground = defineAsyncComponent(() => import("./_nuxt/TokensPlayground-BdpulfBp.js").then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-CjvbTeqX.js").then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-DO3uD5Ee.js").then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-Bo27uQNr.js").then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-BabxK73r.js").then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-a4lwZxUE.js").then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-CLbZBXp8.js").then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-DfGDdgph.js").then((r) => r["default"] || r.default || r));
...
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-DxHUPX7s.js").then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/ProsePre-DNLg-Rt5.js").then((r) => r["default"] || r.default || r));
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-BvjIJ1CR.js").then((r) => r["default"] || r.default || r));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db-CdDw_hOA.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db-CdDw_hOA.js").then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BHxIT3jm.js").then((m) => m.default || m)),
  page: defineAsyncComponent(() => import("./_nuxt/page-D-lgp9IG.js").then((m) => m.default || m))
};
...
const plugin = {
  install(app, options) {
    ...
    if (dev && true) {
      import("./_nuxt/debug-CIpES0ca.js").then(({ usePinceauRuntimeDebug }) => usePinceauRuntimeDebug(tokensHelperConfig));
    }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Cl-v9_9g.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DkdSQIx2.js"));
...
export {
  ...
  _mergeTransitionProps as e,
  _wrapInTransition as f,
  _routeRulesMatcher as g,
  ...
  usePinceauRuntime as n,
  __nuxt_component_0$3 as o,
  computedStyle as p,
  useDocus as q,
  __nuxt_component_0$2 as r,
  useAppConfig as s,
  useState as t,
  useHead as u,
  __nuxt_component_0$4 as v,
  useContentHelpers as w,
  useRouter as x,
  useClipboard as y,
  onClickOutside as z
};
